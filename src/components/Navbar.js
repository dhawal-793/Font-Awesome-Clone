...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="flex py-7 justify-between items-center w-[100%]">
        <button className="md:hidden px-8 pr-11 text-2xl cursor-pointer order-1">
        ...
        <button className="justify-end px-7 order-3 md:order-none text-xl">
